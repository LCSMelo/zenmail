		...
		<table class="table table-striped">
			...
			<c:forEach items="${despesa}" var="d">
				<tr>
					...
					<td>${d.valor}</td>
					<td>
						<fmt:formatDate value="${d.dataDespesa.time }" pattern="dd/MM/yyyy"/>
					</td>
					<td>${d.categoria}</td>
					<td>
						...
						<button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#excluirModal" onclick="codigoExcluir.value = ${d.codigo}">
  							Excluir
						</button>
					</td>
				</tr>
